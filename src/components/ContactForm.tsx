...
function ContactForm() {
  ...
  const sendEmail = (values: any) => {
    emailjs.send("service_38r1mxt","template_g0h5rzl",{
      from_name: values.name,
      to_name: "Lisa Emilson",
    ...
    <Formik
      initialValues={{
       ...
       onSubmit={(values, actions) => {
        ...
        onOpen('All good!', `Thanks for your submission ${values.name}, I will get back to you shortly!`)
